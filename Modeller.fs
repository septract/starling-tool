        ...
        | ArraySubscript (arr, idx) ->
            ...
            bind2
                (fun arrE idxE ->
                    ...
                    | t ->
                        fail (ExprBadType (TypeMismatch (expected = Fuzzy "bool[]", got = Exact t))))
                arrResult idxResult
    ...
    let rec mi e =
        ...
        | ArraySubscript (arr, idx) ->
            ...
            bind2
                (fun arrE idxE ->
                    match arrE.SRec.ElementType with
                    | AnIntR r -> ok (mkTypedSub r (IIdx (arrE, idxE)))
                    | t ->
                        fail (ExprBadType (TypeMismatch (expected = Fuzzy "int[]", got = Exact t))))
                arrResult idxResult
