...
module private ParamDesugar =
    ...
    /// </param>
    /// <returns>
    ///     <paramref name="ctx"/> extended to contain the thread-local variable
    ...
    let desugarMethodParams
      ...
      : DesugarContext * Map<string, string> =
        ...
        { ctx with ThreadVars = tvars }, tsubs
...
let desugar
  ...
  : (DesugarContext * Map<string, FullBlock<ViewExpr<DesugaredGView>, FullCommand>>) =
    ...
    let desugarParams ctx pos pars body =
        let ctxP, tsubs = ParamDesugar.desugarMethodParams ctx pars pos
