...
echo "Framer:"
./starling.sh -h -s frame $1 | $SED -n "$SELECT_PATTERN" | $SED "$DELETE_PATTERN"
echo "TermGen:"
./starling.sh -h -s termgen $1 | $SED -n "$SELECT_PATTERN" | $SED "$DELETE_PATTERN"
echo "Reify:"
./starling.sh -h -s reify $1 | $SED -n "$SELECT_PATTERN" | $SED "$DELETE_PATTERN"
echo "Z3:"
./starling.sh -h -s z3 $1 | $SED -n "$SELECT_PATTERN" | $SED "$DELETE_PATTERN"
